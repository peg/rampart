...
LDFLAGS  = -s -w \
	-X github.com/rampart-project/rampart/internal/build.Version=$(VERSION) \
	-X github.com/rampart-project/rampart/internal/build.Commit=$(COMMIT) \
	-X github.com/rampart-project/rampart/internal/build.Date=$(DATE)
