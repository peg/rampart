...
description: Monitor AI agent activity in Wazuh — decode Rampart audit events, alert on denies, and correlate high-frequency blocks as possible prompt injection.
---
