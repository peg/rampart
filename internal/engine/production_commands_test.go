...
func TestProductionGuardCLI(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{`pulumi -h --help=false up --yes`, ActionAsk},
		{`pulumi --help -h=false up --yes`, ActionAsk},
		...
		{`kubectl -h --help=false apply --context prod -f file.yaml`, ActionAsk},
		{`kubectl --help -h=false apply --context prod -f file.yaml`, ActionAsk},
		...
		{`pulumi -h=false --help up --yes`, ActionAllow},
		{`pulumi --help=false -h up --yes`, ActionAllow},
		...
		{`kubectl -h=false --help apply --context prod -f file.yaml`, ActionAllow},
		{`kubectl --help=false -h apply --context prod -f file.yaml`, ActionAllow},
