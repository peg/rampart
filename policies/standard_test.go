...
func TestStandardPolicyDecisions(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "deny read ssh key windows backslash", tool: "read", path: "C:\\Users\\Alice\\.ssh\\id_rsa", expected: engine.ActionDeny},
		...
		{name: "deny read aws credentials windows", tool: "read", path: "C:\\Users\\Alice\\.aws\\credentials", expected: engine.ActionDeny},
		{name: "deny read dot env", tool: "read", path: "~/.env", expected: engine.ActionWatch},
		{name: "deny read dot env windows", tool: "read", path: "C:\\Users\\Alice\\project\\.env", expected: engine.ActionWatch},
		{name: "deny read azure token windows", tool: "read", path: "C:\\Users\\Alice\\.azure\\accessTokens.json", expected: engine.ActionDeny},
		{name: "deny read kube config windows", tool: "read", path: "C:\\Users\\Alice\\.kube\\config", expected: engine.ActionDeny},
		{name: "deny read chrome data windows", tool: "read", path: "C:\\Users\\Alice\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Login Data", expected: engine.ActionDeny},
		...
		{name: "allow read env example windows", tool: "read", path: "C:\\Users\\Alice\\project\\.env.example", expected: engine.ActionAllow},
